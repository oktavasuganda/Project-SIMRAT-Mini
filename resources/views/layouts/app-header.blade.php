    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="w-40 dark:hidden" src="/images/logo/logo-dark.png" alt="Logo" height="40" />
                <img class="w-40 hidden dark:block" src="/images/logo/logo-white.png" alt="Logo" height="40" />
            </a>
